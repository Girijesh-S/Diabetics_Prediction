...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(
        ...
        email_template_name='prediction/emails/password_reset_email.html',
        success_url=reverse_lazy('prediction:password_reset_done')
    ), name='password_reset'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(
        ...
        success_url=reverse_lazy('prediction:login')
    ...
    path('report/<int:pk>/email/', views.email_report, name='email_report'),  # Email report to user
